  ...
  <Layout>
    <section style={{ padding: '0 1rem 1rem 1rem' }}>
      ...
      <p>
        ...
        React query in addition to possible alternatives. Its important to note
        that this implementations are just for ideation and discussion. They are
        not setting a precedence.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          fetch related data similar to the useLazyQuery/useLazyPromise pattern
        </li>
        <li>
        ...
        <li>
          ...
          cache to and from localStorage using the `react-query/hydration` APIs
        </li>
      </ul>
      ...
      <p>
        It is highly recommended to have a scan through the docs before starting
        the exercises.
      </p>
      ...
      <p>
        ...
        source is the <strong>store.json</strong> file at the root of the repo.
        The code within the <strong>db</strong> directory is acting as a form or
        very simple ODM to access this data. We use{' '}
